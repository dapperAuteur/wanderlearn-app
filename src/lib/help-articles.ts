...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    audience: "partner",
    steps: [
      "Sign in, then click the round Get help button in the corner of any page. It takes you straight to the new-thread form. You can also go to /support and click New thread. Support threads require an account: there are no anonymous tickets.",
