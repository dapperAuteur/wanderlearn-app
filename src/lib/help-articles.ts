...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Click Open thread. Follow the conversation at /support: the Wanderlust team replies both in-app and by email, and you can reply in the thread at any time.",
