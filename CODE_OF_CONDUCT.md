...
- Crediting the work of others, including the communities whose places, knowledge, and heritage are featured on the platform
...
- Compensate communities whose heritage is featured, not just the institutions that documented it
- Defer to the affected community when in doubt about how something should be represented
- Accept corrections and takedown requests from affected communities in good faith and act on them promptly

Content that fails these standards may be removed without warning, regardless of the contributor's intent.
...
Project maintainers have the right and responsibility to remove, edit, or reject comments, commits, code, wiki edits, issues, pull requests, in-app support chat messages, and other contributions that are not aligned to this Code of Conduct, and will communicate reasons for moderation decisions when appropriate.
...
- Links to any available public record (e.g., a mailing-list archive or public IRC logger)
- Any additional information that may be helpful

You will receive a response within **72 hours**. The project team is obligated to maintain confidentiality with regard to the reporter of an incident.

If you are reporting a **security vulnerability**, follow the same address but mark the subject line with `[SECURITY]`. Please do not open public issues for security problems.
